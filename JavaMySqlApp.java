...
public class JavaMySqlApp {
    ...
    public static void main(String args[]) {
        ...
        do {
            ...
            switch (iOption) {
                case 0: // Incluir
                    uDraft.setUser(JOptionPane.showInputDialog(null, "Digite o Usuário:", "Incluir",
                            JOptionPane.QUESTION_MESSAGE));
                    uDraft.setPass(JOptionPane.showInputDialog(null, "Digite a Senha:", "Incluir",
                            JOptionPane.QUESTION_MESSAGE));
                ...
                case 1: // Consultar
                    uDraft.setUser(JOptionPane.showInputDialog(null, "Digite o Usuário:", "Consultar",
                            JOptionPane.QUESTION_MESSAGE));
                    cBD.consultarReg(uDraft);
                    break;

                case 2: // Alterar
                    uDraft.setUser(JOptionPane.showInputDialog(null, "Digite o Usuário:", "Alterar",
                            JOptionPane.QUESTION_MESSAGE));
                    uDraft.setPass(JOptionPane.showInputDialog(null, "Digite a Senha:", "Alterar",
                            JOptionPane.QUESTION_MESSAGE));
                ...
                case 3: // Excluir
                    uDraft.setUser(JOptionPane.showInputDialog(null, "Digite o Usuário:", "Excluir",
                            JOptionPane.QUESTION_MESSAGE));
                ...
                case 4: // Listar
                    JOptionPane.showMessageDialog(null,
                            "Acione OK para ver no console os usuários e senhas cadastrados!");
